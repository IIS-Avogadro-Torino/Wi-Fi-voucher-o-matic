...
##
# Questa pagina è una presentazione delle tipologie di utenze disponibili
##
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="mbr-figure">
                    <div><img src="<?php echo STATIC_ROOT ?>/images/avowifiok-1400x602.png" alt="Avo Wi-Fi logo"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xs-12  col-md-6 col-xl-3">
                <div class="mbr-plan card text-xs-center">
                    ...
                    <div class="mbr-plan-body card-block">
                      ...
                      <div class="mbr-plan-btn"><a href="https://www.grupporete.itisavogadro.org/osticket/open.php?topicId=69" class="btn btn-black btn-black-outline">Chiedi</a></div>
                    </div>
                </div>
            </div>
          </div>
